...
class Constants {
    ...
    companion object {
        ...
        const val TABLE_ORDER_IS_PAYMENT = "is_payment"
        const val TABLE_ORDER_IS_CONFIRMED_ORDERING = "is_confirmed_ordering"
        const val TABLE_ORDER_IS_UNSUCCESSFUL_PAYMENT = "is_unsuccessful_payment"
        const val TABLE_ORDER_IS_DELIVERY = "is_delivery"
        const val TABLE_ORDER_IS_SUCCESS = "is_success"
        const val TABLE_ORDER_IS_CANCEL = "is_cancel"

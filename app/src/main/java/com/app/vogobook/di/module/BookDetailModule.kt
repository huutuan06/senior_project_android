...
class BookDetailModule(private val bookDetailFragment: BookDetailFragment, private val view: BookDetailView) {
    ...
    @Provides
    @FragmentScope
    fun provideSnackBar(snackbarLayout: CartSnackBarLayout, activity: MainActivity, context: Context): Snackbar {
        ...
        layout.background = ContextCompat.getDrawable(context, com.app.vogobook.R.color.windowBackground)
